...
import { useTheme } from '../contexts/ThemeContext'; // Theme context for dark mode
import { toast } from 'react-hot-toast'; // For toast notifications
import { Mail, Lock, Eye, EyeOff, Loader2, ArrowRight } from 'lucide-react'; // Icons from Lucide React
import { FcGoogle } from 'react-icons/fc'; // For the Google icon

/**
 * Login page component with enhanced UI/UX, validation, and split-screen design.
 */
function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await loginWithEmail(email, password); // Use the new Firebase login function
    ...
    <div className="flex items-center justify-center min-h-[calc(100vh-80px)] p-4">
      <div className="flex flex-col md:flex-row w-full max-w-5xl rounded-2xl shadow-2xl overflow-hidden bg-white dark:bg-gray-800 transition-colors duration-300">
        ...
        <div className="relative md:w-1/2 bg-gradient-to-br from-purple-600 to-indigo-700 dark:from-purple-800 dark:to-indigo-900 text-white p-8 flex flex-col justify-center items-center text-center py-16 md:py-24">
          {/* Abstract Shapes - Enhanced for more depth/3D feel */}
          ...
          <div className="relative z-10 flex flex-col items-center">
            <div className="mb-6">
              {/* Placeholder for a logo - Larger and more prominent */}
              <svg className="w-24 h-24 mx-auto text-white opacity-90 drop-shadow-lg" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <p className="text-lg opacity-90 mb-8 max-w-xs drop-shadow-md">
              Sign in to continue access
            </p>
            <Link
              to="/register"
              className="inline-flex items-center justify-center px-8 py-3 border border-white rounded-full text-white font-semibold hover:bg-white hover:text-purple-700 transition duration-300 ease-in-out transform hover:scale-105 shadow-lg"
            >
        ...
        <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <div className="text-right mt-2">
                <Link to="/forgot-password" className="text-purple-600 hover:text-purple-800 dark:text-purple-400 dark:hover:text-purple-300 text-sm font-semibold">
                  Forgot password?
                </Link>
              </div>
            </div>
          ...
          <div className="flex flex-col space-y-3 mt-4">
            ...
            <button
              ...
              onClick={() => toast.info('Facebook Sign-in placeholder.')}
              disabled={loading}
            >
